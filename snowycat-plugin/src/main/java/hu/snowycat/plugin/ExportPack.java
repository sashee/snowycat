...
public class ExportPack extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			SnowyCat.exportPack(driverName, url, userName, password, targetFileName, resourceDirs.compareTo("") == 0 ? new String[] {} : resourceDirs.split("[,]"));
		} catch (Exception e) {
